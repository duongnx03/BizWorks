  ...
  const fetchEmployees = async () => {
    ...
    try {
      const response = await axios.get(
        "http://localhost:8080/api/emp-queue/getAll",
        {
                          ...
                          {currentEmployees.map((employee) => (
                            <tr key={employee.id}>
                              ...
                              <td>
                                <div className="d-flex align-items-center">
                                  <Link
                                    to={`/client-profile/${employee.censor.employee.id}`}
                                    className="me-3"
                                  >
                                    <div
                                      style={{
                                  ...
                                  <div>
                                    <Link
                                      ...
                                      className="text-decoration-none fw-bold text-dark"
                                    >
                                      {employee.censor.employee.empCode}{" "}
                                      -{" "}
                                      {employee.censor.employee.fullname}
                                    </Link>
                                    <div className="mt-1">
                                      <span className="d-block fw-semibold">
                                        {
